...
/**
 * DEVSAnimatorUnit - the DEVSAnimator with Time and Duration. <br>
 * <br>
 ...
 */
public class DEVSAnimatorUnit extends DEVSAnimator<Time, Duration, SimTimeUnit>
        implements DEVSSimulatorInterfaceUnit, AnimatorInterface
{
    ...
    /**
     * Create a new DEVSAnimatorUnit.
     */
    public DEVSAnimatorUnit()
    {
        super();
    }
    ...
    {
        return "DEVSAnimatorUnit [time=" + getSimulatorTime().getTime() + "]";
    }
