    ...
    public void constructModel()
    {
        try
        {
            if (getSimulator() instanceof AnimatorInterface)
            {
                ...
                ATOYP ypManufacturer = new ATOYP("yellow-page-manufacturer", getSimulator(), new Point3d(-300, -270, 1), ing);
                ...
                ATOSupplier SupPartCa = new ATOSupplier("supplier-partCa-Poland", getSimulator(), new Point3d(0, 150, 1), ing,
                        new Money(1000000, MoneyUnit.USD), partCa, 10, ypSupplier, streamATO, true);
                ATOSupplier SupPartCb = new ATOSupplier("supplier-partCb-Denmark", getSimulator(), new Point3d(0, 150, 1), ing,
                        new Money(1000000, MoneyUnit.USD), partCb, 20, ypSupplier, streamATO, true);
                ATOSupplier SupPartCc = new ATOSupplier("supplier-partCb-Austria", getSimulator(), new Point3d(0, 150, 1), ing,
