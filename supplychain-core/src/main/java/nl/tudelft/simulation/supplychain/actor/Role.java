...
/**
 * Role is a template for a consistent set of policies for handling messages,
 * representing a certain part of the organization, such as sales, inventory,
 * finance, or purchasing. When a Role receives a message, it goes first through
 * the MessageReceiver that can cause delay (e.g., schedules, use of resources).
 * After that, the Role dispatches the messages to one or more MessagePolicy
 * classes that handle the messages.
 * <p>
...
public abstract class Role implements Identifiable, Serializable {
	 ...
	 * @param messageReceiver MessageReceiver; the message handler to use for
	...
	/**
	 * Set a message handling policy for a message type, possibly overwriting the
	 * previous message handling policy.
	 * 
	...
	/**
	 * This is the core processing of a message that was received. All appropriate
	 * policies of the actor or role are executed.
	 * 
