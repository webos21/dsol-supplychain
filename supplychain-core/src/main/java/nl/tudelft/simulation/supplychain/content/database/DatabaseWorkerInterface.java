 ...
 * @author <a href="https://www.tudelft.nl/averbraeck" target="_blank">Alexander Verbraeck</a> FOs
 */
public interface DatabaseWorkerInterface extends Serializable
{
    /**
     ...
     * @param actorName the actor to look for
