...
/**
 * SupplyChainModelInterface defines the specific methods of a supply chain
 * model.
 * <p>
...
public interface SupplyChainModelInterface extends DsolModel<Duration, SupplyChainSimulatorInterface> {
	...
	/**
	 * Calculate the distance between two points as a Length. The point could be in
	 * lat/lon, on an orthogonal grid, or based on a GIS projection.
	 * 
	...
	/**
	 * Calculate the distance between two points in km. The point could be in
	 * lat/lon, on an orthogonal grid, or based on a GIS projection.
	 * 
	 * @param loc1 Point; first location
	 * @param loc2 Point; second location
	 ...
	 * @throws ActorNotFoundException when the actor was not registered in the Actor
	 *                                map
	 */
