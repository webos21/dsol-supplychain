...
/**
 * DistContinuousMoney wraps any continuous distribution and can draw Money
 * instances with a given MoneyUnit.
 * <p>
...
public class DistContinuousMoney extends Dist {
	 ...
	 * 
	 * @param wrappedDistribution DistContinuous; the wrapped continuous
	 *                            distribution
	 * @param moneyUnit           MoneyUnit; the money unit for the values of the
	 *                            distribution
	 */
	...
	/**
	 * Draw the next stream value according to the probability of this this
	 * distribution.
	 * 
	...
	/**
	 * Return the money unit in which the samples from the wrapped distribution are
	 * returned.
	 * 
	 * @return MoneyUnit; the money unit in which the samples from the wrapped
