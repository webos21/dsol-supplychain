...
/**
 * Money implements a monetary value and is modeled after the Scalar and Unit in
 * djunits.
 * <p>
 * Copyright (c) 2019-2023 Delft University of Technology, Delft, the
...
public class Money extends Number implements Serializable {
	...
	/**
	 * Return a monetary amount that is the sum of this monetary amount and the
	 * increment.
	 * 
	 * @param inc Money; the amount of money to add
	 * @return Money; a monetary amount that is the sum of this monetary amount and
	 *         the increment
	 */
	...
	/**
	 * Return a monetary amount that is the difference of this monetary amount and
	 * the decrement.
	 * 
	 * @param dec Money; the amount of money to subtract
	 * @return Money; a monetary amount that is the diffference of this monetary
	 *         amount and the decrement
	 */
	...
	/**
	 * Return a monetary amount that is the multiplication of this monetary amount
	 * and the factor.
	 * 
	 * @param factor double; the multiplication factor
	 * @return Money; a monetary amount that is the multiplication of this monetary
	 *         amount and the factor
	 */
	...
	/**
	 * Return a monetary amount that is the division of this monetary amount by the
	 * factor.
	 * 
	 * @param factor double; the division factor
	 * @return Money; a monetary amount that is the division of this monetary amount
	 *         by the factor
	 */
	 ...
	 * @return boolean; whether this monetary amount is equal to the other monetary
	 *         amount
	 */
	 ...
	 * 
	 * @param other Money; the other monetary amount to compare with
	 * @return boolean; whether this monetary amount is unequal to the other
	 *         monetary amount
	 */
	 ...
	 * 
	 * @param other Money; the other monetary amount to compare with
	 * @return boolean; whether this monetary amount is less than the other monetary
	 *         amount
	 */
	...
	/**
	 * Return whether this monetary amount is less than or equal to the other
	 * monetary amount.
	 * 
	 * @param other Money; the other monetary amount to compare with
	 * @return boolean; whether this monetary amount is less than or equal to the
	...
	/**
	 * Return whether this monetary amount is greater than the other monetary
	 * amount.
	 * 
	 * @param other Money; the other monetary amount to compare with
	 * @return boolean; whether this monetary amount is greater than the other
	 *         monetary amount
	 */
	...
	/**
	 * Return whether this monetary amount is greater than or equal to the other
	 * monetary amount.
	 * 
	 * @param other Money; the other monetary amount to compare with
	 * @return boolean; whether this monetary amount is greater than or equal to the
	 *         other monetary amount
	 */
