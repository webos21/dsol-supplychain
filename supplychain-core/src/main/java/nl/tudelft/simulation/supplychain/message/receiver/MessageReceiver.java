...
/**
 * MessageReceiver contains the base implementation of a message receiver. A
 * message receiver simulates the queuing method for incoming messages before
 * they are processed. Receiving can be done immediately, after a delay,
 * periodically, or after the appropriate resources are available.
 * <p>
...
public abstract class MessageReceiver implements Identifiable, Serializable {
	...
	/**
	 * Set the role to which this receiver belongs; can only be called once,
	 * preferably in the constructor of the Role.
	 * 
	...
	/**
	 * This is the core dispatching method for the processing of a message that was
	 * received.
	 * 
	 * @param message       M; the message to process
	 * @param messagePolicy MessagePolicy&lt;M&gt;; the policy to execute on the
	 *                      message
	 * @param <M>           The message type to ensure that the message and policy
	 *                      align
	 */
