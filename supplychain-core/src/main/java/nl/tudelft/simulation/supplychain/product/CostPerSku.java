...
/**
 * CostPerSKU indicates a cost for, e.g., storing, transporting, (un)loading of
 * one SKU, independent of the product.
 * <p>
...
public class CostPerSku implements Serializable {
	 ...
	 * @param cost Money; the cost for, e.g., storing, transporting, (un)loading of
	 *             one SKU.
	 */
	 ...
	 * 
	 * @return cost Money; the cost for, e.g., storing, transporting, (un)loading of
	 *         one SKU
	 */
