...
/**
 * SKU stands for Stock Keeping Unit. At this moment, it just is a placeholder
 * for a unit name, providing some standard static Unit types. We could provide
 * extensions of this class allowing to calculate weight or volume of products,
 * based on the density of the product. It could also provide some basic
 * measures to translate the number of units from one Unit class to the other.
 * <p>
