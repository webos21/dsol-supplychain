...
/**
 * StochasticTransportOption describes a way to get goods from A to B, with
 * stochastically described times and costs. The class can incicate a singular
 * transport mode that transports the goods from A to B, e.g., trucking, or a
 * multimodal option that involves, e.g., a truck to the Port, a containrship to
 * another port, and trucking to the final destination. Each of the modes has a
 * different speed, and each of the transfers will take time (and possibly cost
 * money),
 * <p>
...
public class StochasticTransportOption implements Identifiable, Serializable {
	 ...
	 * 
	 * @return ImmutableList&lt;StochasticTransportOptionStep&gt;; the transport
	 *         steps
	 */
	 ...
	 * 
	 * @param transportOptionStep StochasticTransportOptionStep; the new transport
	 *                            step
	 */
	 ...
	 * 
	 * @param steps List&lt;StochasticTransportOptionStep&gt;; the new transport
	 *              steps
	 */
