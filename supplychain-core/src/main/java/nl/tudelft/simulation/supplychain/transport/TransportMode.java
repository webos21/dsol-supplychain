...
/**
 * TransportMode stores the information on a mode of transport, to transport
 * products from an origin to a destination.
 * <p>
...
public class TransportMode implements Identifiable, Serializable {
	 ...
	 * 
	 * @param sku SKU; a SKU to be added to the set of SKUs that this TransportMode
	 *            can handle
	 */
	 ...
	 * 
	 * @return handledSkuSet ImmutableSet&lt;Sku&gt;; the set of SKUs that this
	 *         TransportMode can handle
	 */
