...
/**
 * TransportStep models one step of a TransportOption. It describes the origin
 * Node and destination Node (as an Actor -- any location where trandsfer takes
 * place, such as a port or terminal, is seen as an actor in the logistics
 * network), estimated loading time at the origin Node and estimated unloading
 * time at the destination Node, the mode of transport between origin and
 * destination, and the costs associated with loading and with unloading
...
public class TransportOptionStep implements Identifiable, Serializable {
	 ...
	 *                      destination
	 */
	public TransportOptionStep(final String id, final Actor origin, final Actor destination,
	 ...
	 * @return Duration; the estimated time to load goods at the origin (including
	 *         typical waiting times), or null when there is no stored loading time
	 ...
	 * @return Duration; the estimated time to unload goods at the destination
	 *         (including typical waiting times), or null when there is no stored
	 *         unloading time for the provided SKU
	 */
	 ...
	 * @return Money; the estimated costs for loading and storing the goods at the
	 *         origin location, or null when there is no stored loading cost for the
	 *         provided SKU
	 */
	 ...
	 * @return Money; the estimated costs for unloading and storing the goods at the
	 *         destination location, or null when there is no stored unloading cost
	 *         for the provided SKU
	 */
	 ...
	 * @return Money; the estimated estimated transport cost for the SKU per km, for
	 *         the TransportStep's transport mode, or null when there is no stored
	 ...
	 * @param estimatedLoadingTime Duration; new estimated time to load goods at the
	 *                             origin (including typical waiting times)
	 */
	 ...
	 * @param estimatedUnloadingTime Duration; new estimated time to unload goods at
	 *                               the destination (including typical waiting
	 *                               times)
	 */
	 ...
	 * @param estimatedLoadingCost Money; new cost estimate for loading and storing
	 *                             the goods at the origin location
	 */
	 ...
	 * @param estimatedUnloadingCost Money; new cost estimate for unloading and
	 *                               storing the goods at the destination location
	 */
	 ...
	 *                                    for
	 * @param estimatedTransportCostPerKm Money; the estimated estimated transport
	 *                                    cost for the SKU per km, for the
	 *                                    TransportStep's transport mode
	 */
