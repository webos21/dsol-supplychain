...
public class MTSMTOModel extends SupplyChainModel {
	...
	public void constructModel() {
		try {
			if (getSimulator() instanceof AnimatorInterface) {
				...
				new SingleImageRenderable<>(new OrientedPoint3d(0.0, 0.0, -Double.MIN_VALUE), new Bounds3d(800, 600, 0),
						getSimulator(), TestModel.class
								.getResource("/nl/tudelft/simulation/supplychain/demo/mtsmto/images/background.gif"));
			}
			...
			DemoYP ypCustomerMTS = new DemoYP("YP_customer_MTS", getSimulator(), new OrientedPoint3d(-300, -270, 1),
					ing);
			DemoYP ypCustomerMTO = new DemoYP("YP_customer_MTO", getSimulator(), new OrientedPoint3d(-300, 30, 1), ing);
			DemoYP ypProductionMTS = new DemoYP("YP_production_MTS", getSimulator(), new OrientedPoint3d(100, -270, 1),
					ing);
			DemoYP ypProductionMTO = new DemoYP("YP_production_MTO", getSimulator(), new OrientedPoint3d(100, 30, 1),
					ing);
