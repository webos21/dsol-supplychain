...
/**
 * The GISContentAnimation is useful in combination with a GIS based map as a
...
public class GISContentAnimation extends SingleImageRenderable {
	 ...
	 */
	public GISContentAnimation(final Locatable locatable, final SupplyChainSimulatorInterface simulator,
			final URL imageURL) throws RemoteException, NamingException {
