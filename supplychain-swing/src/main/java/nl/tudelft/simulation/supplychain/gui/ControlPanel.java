        ...
        implements ActionListener, PropertyChangeListener, WindowListener, EventListenerInterface
{
    ...
    protected class DisposeOnCloseThread extends Thread
    {
         ...
         */
        public DisposeOnCloseThread(final ControlPanel panel)
        {
            super();
            this.panel = panel;
        }
    ...
    public final void actionPerformed(final ActionEvent actionEvent)
    {
        ...
        try
        {
            ...
            if (actionCommand.equals("Reset"))
            {
                ...
                frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
                frame.dispose();
                ControlPanel.this.cleanup();
                try
                {
                    ControlPanel.this.wrappableAnimation.rebuildSimulator(rect);
                }
        ...
        for (JButton button : this.buttons)
        {
            ...
            else if (actionCommand.equals("RunPause"))
            {
                ...
                if (this.simulator.isRunning())
                {
                    ...
                    button.setIcon(ControlPanel.loadIcon("/Pause.png"));
                }
                else
                {
