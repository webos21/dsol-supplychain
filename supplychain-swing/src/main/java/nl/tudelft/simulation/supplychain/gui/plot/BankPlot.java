...
public class BankPlot extends XYChart
{
     ...
     * @param bankAccount
     */
    public BankPlot(SCSimulatorInterface simulator, String title, BankAccount bankAccount)
    {
    ...
    private static class BalanceListener extends EventProducer implements EventListenerInterface
    {
         ...
         * @param bankAccount
         */
        public BalanceListener(SCSimulatorInterface simulator, BankAccount bankAccount)
        {
            super();
